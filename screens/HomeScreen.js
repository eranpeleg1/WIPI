                                            ...
                                            followsUserLocation={true}>
                                            {
                                                this.state.reports.map((report,key)=> {
                                                    ...
                                                    switch (report.reportType){
                                                        ...
                                                        // image =  (<Svg  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 34.01 45">
                                                        // <G id="location"><Path id="Shape" d="M17,0A17,17,0,0,0,0,16.87c0,11.7,15.35,27.07,16,27.72a1.43,1.43,0,0,0,2,0c.65-.65,16-16,16-27.72A17,17,0,0,0,17,0Z" transform="translate(0 0)" fill="#00c600"/>
                                                        // </G>
                                                        // <G id="Oval_3" data-name="Oval 3">
                                                        //     <Circle id="Oval_3-2" data-name="Oval 3-2" cx="17" cy="17" r="13" fill="#fff"/>
                                                        // </G>
                                                        // <G id="bicycle">
                                                        // <Path id="Path_40" data-name="Path 40" d="M9.77,15.06A6.21,6.21,0,1,0,16,21.27,6.21,6.21,0,0,0,9.77,15.06Zm0,10.65a4.44,4.44,0,0,1,0-8.87h0a4.44,4.44,0,0,1,0,8.87Z" transform="translate(0 0)" fill="#68544f"/>
                                                        // <Path id="Path_41" data-name="Path 41" d="M26.76,15.06a6.24,6.24,0,1,0,.06,0Zm0,10.65a4.44,4.44,0,0,1,0-8.87h0a4.44,4.44,0,1,1,0,8.87Z" transform="translate(0 0)" fill="#53433f"/>
                                                        // <Path id="Path_42" data-name="Path 42" d="M13.08,13.29a.88.88,0,0,1-.88-.89V8.85a.89.89,0,1,1,1.77,0V12.4a.89.89,0,0,1-.89.89Z" transform="translate(0 0)" fill="#70da40"/><Path id="Path_43" data-name="Path 43" d="M14.88,9.74H11.33a.89.89,0,0,1,0-1.78h3.55a.89.89,0,0,1,0,1.78Z" transform="translate(0 0)" fill="#68544f"/>
                                                        // <Path id="Path_44" data-name="Path 44" d="M27.65,11.51H24.1l-.88-1.6L24.1,8h4.44a.89.89,0,0,1,.89.89v.89a1.78,1.78,0,0,1-1.78,1.77Z" transform="translate(0 0)" fill="#dfd7d5"/>
                                                        // <Path id="Path_45" data-name="Path 45" d="M24.37,7.08a2.66,2.66,0,0,0-2.66-2.66H19.94a.89.89,0,1,0,0,1.77h1.77a.89.89,0,0,1,.89.89V8l.83.89L24.37,8Z" transform="translate(0 0)" fill="#53433f"/>
                                                        // <Path id="Path_46" data-name="Path 46" d="M23.45,13.29a.89.89,0,0,0,.89-.89V8H22.56V12.4A.89.89,0,0,0,23.45,13.29Z" transform="translate(0 0)" fill="#56c225"/>
                                                        // <Path id="Path_47" data-name="Path 47" d="M26.45,20.46a.87.87,0,0,1-1.11-.5l-2.55-6.68H13.73l-2.39,6.21-.7,1.83a.87.87,0,0,1-.8.55,1.12,1.12,0,0,1-.31-.05.89.89,0,0,1-.47-1.15L9.5,19.5l2.86-7.44a.84.84,0,0,1,.79-.55H23.37a.82.82,0,0,1,.78.55l2.78,7.24a.9.9,0,0,1-.48,1.16Z" transform="translate(0 0)" fill="#70da40"/>
                                                        // <Path id="Path_48" data-name="Path 48" d="M24.22,13l-6,7.33L17,21.73a.89.89,0,0,1-.69.32.9.9,0,0,1-.57-.2.92.92,0,0,1-.13-1.26l2.56-3.12,4.63-5.64Z" transform="translate(0 0)" fill="#70da40"/>
                                                        // <Path id="Path_49" data-name="Path 49" d="M24.19,13l-6,7.33V17.47l4.64-5.64Z" transform="translate(0 0)" fill="#56c225"/>
                                                        // <Path id="Path_50" data-name="Path 50" d="M26.64,20.46a.92.92,0,0,1-1.15-.5l-2.66-6.68H18.11V11.51h5.32a.89.89,0,0,1,.82.55l2.89,7.24a.89.89,0,0,1-.49,1.15Z" transform="translate(0 0)" fill="#56c225"/>
                                                        // <Path id="Path_51" data-name="Path 51" d="M19.53,21.27a1.76,1.76,0,0,1-.89,1.53,1.73,1.73,0,0,1-.89.25H8.88a1.78,1.78,0,0,1,0-3.55h8.87a1.72,1.72,0,0,1,.89.24A1.77,1.77,0,0,1,19.53,21.27Z" transform="translate(0 0)" fill="#dfd7d5"/>
                                                        // <Path id="Path_52" data-name="Path 52" d="M26.76,23.93a2.66,2.66,0,1,1,2.67-2.66h0A2.67,2.67,0,0,1,26.76,23.93Z" transform="translate(0 0)" fill="#d2c5c2"/>
                                                        // </G>
                                                        // </Svg>
                                                       image=( <Svg xmlns="http://www.w3.org/2000/svg" width="29" height="40" viewBox="0 0 29 40">
                                                        ...
                                                        case 'parking officer':
                                                            ...
                                                            break
                                                        case 'towing truck':
                                                            image = (<Svg xmlns="http://www.w3.org/2000/svg" width="500" height="200" viewBox="0 0 500 200">
                                                            <G fill="none" transform="translate(0 .944)">
                                                              <Path fill="#FFA733" d="M14.5590537,0.000297546387 L14.4980662,0 C6.50394447,0 0,6.5055542 0,14.5021134 C0,18.8861618 2.24047232,22.3055649 4.73679455,25.7103882 L14.4790262,39 L24.2632054,25.7106857 C26.7592302,22.3058625 29,18.8864593 29,14.5024109 C29,6.52578735 22.5269955,0.0327301406 14.5590537,0.000297546387 Z M14.4998513,24.281868 C9.10825921,24.281868 4.72191959,19.8948441 4.72191959,14.5021134 C4.72191959,9.10968018 9.10825921,4.72265625 14.4998513,4.72265625 C19.8917408,4.72265625 24.2780804,9.10968018 24.2780804,14.5021134 C24.2780804,19.8948441 19.8917408,24.281868 14.4998513,24.281868 Z"/>
